...
public class RdpVal {
  ...
  public static string Validate(string path){
    ...
    var sigM=Regex.Match(text, @"signature:s:([A-Za-z0-9+/=\s]+)", RegexOptions.IgnoreCase);
    ...
    try{
      ...
      var ch=new X509Chain(); ch.ChainPolicy.RevocationMode=X509RevocationMode.Online; ch.ChainPolicy.RevocationFlag=X509RevocationFlag.EntireChain; ch.ChainPolicy.UrlRetrievalTimeout=TimeSpan.FromSeconds(15); ch.ChainPolicy.ExtraStore.AddRange(cms.Certificates);
